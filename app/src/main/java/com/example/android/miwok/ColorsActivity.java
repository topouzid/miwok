...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        WordAdapter colors = new WordAdapter(this, colorsWords, getResources().getColor(R.color.category_colors));
            ...
            new AudioManager.OnAudioFocusChangeListener() {
                public void onAudioFocusChange(int focusChange) {
                    if (focusChange == AudioManager.AUDIOFOCUS_LOSS_TRANSIENT) {
                        ...
                        Toast toast = Toast.makeText(ColorsActivity.this, "Paused due to phone call", Toast.LENGTH_LONG);
                        toast.show();
                        ...
                        mediaPlayer.pause();
                        Toast toast = Toast.makeText(ColorsActivity.this, "Paused due to short notification", Toast.LENGTH_SHORT);
                        toast.show();
                        ...
                        mediaPlayer.start();
                        Toast toast = Toast.makeText(ColorsActivity.this, "Audio resuming...", Toast.LENGTH_SHORT);
                        toast.show();
                    }
                }
            };
