...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        WordAdapter familyAdapter = new WordAdapter(this, familyMembers, getResources().getColor(R.color.category_family));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Word currentWord = familyMembers.get(position);
            ...
            new AudioManager.OnAudioFocusChangeListener() {
                public void onAudioFocusChange(int focusChange) {
                    if (focusChange == AudioManager.AUDIOFOCUS_LOSS_TRANSIENT) {
                        ...
                        Toast toast = Toast.makeText(FamilyActivity.this, "Paused due to phone call", Toast.LENGTH_LONG);
                        toast.show();
                        ...
                        mediaPlayer.pause();
                        Toast toast = Toast.makeText(FamilyActivity.this, "Paused due to short notification", Toast.LENGTH_SHORT);
                        toast.show();
                        ...
                        mediaPlayer.start();
                        Toast toast = Toast.makeText(FamilyActivity.this, "Audio resuming...", Toast.LENGTH_SHORT);
                        toast.show();
                    }
                }
            };
